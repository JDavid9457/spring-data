/* Populate tables */
INSERT INTO clientes (nombre, apellido, email, create_at, foto) VALUES('David ','Sanchez', 'b-l-ck@hotmail.com', '1994-07-05', '');
...
INSERT INTO productos (nombre, precio, create_at) VALUES('Iphone 12 pro ', 1599990, NOW());
...
INSERT INTO `users` (username, password, enabled) VALUES ('david','$2a$10$ATwxqWrnVsVNy/gKxhwGzeN6RJryy53rkUFWKKr/jeQg5Mz3qO5f6',1);
INSERT INTO `users` (username, password, enabled) VALUES ('admin','$2a$10$JXh5m.1yDOLtYmTUpptp5OnOfXsjcVECnP1dLPy6IlJn3T.YwBAJu',1);
