	...
	public String eliminar(@PathVariable(value = "id") Long id, RedirectAttributes flash,Locale locale) {
		...
		if (id > 0) {
			...
			if (uploadFileService.delete(cliente.getFoto())) {
				String mensajeDeEliminacionDeFoto = String.format(messageSource.getMessage("text.cliente.flash.foto.eliminar.success", null,locale),cliente.getFoto());
				flash.addFlashAttribute("info", mensajeDeEliminacionDeFoto);
			}
